...
export function DashboardClient({
  ...
  const [selectedOrg, setSelectedOrg] = useState<string>(initialOrganization?.id || "");
  ...
  useEffect(() => {
    ...
    if (selectedOrg !== initialOrganization?.id || statusFilter !== "all") {
      fetchProjects();
    }
  }, [selectedOrg, statusFilter, initialOrganization?.id]);
